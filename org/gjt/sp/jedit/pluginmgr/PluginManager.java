...
public class PluginManager extends JFrame
{
	...
	private void init()
	{
		...
		tabPane.addTab(jEdit.getProperty("plugin-packages.title"),
			packages = new PackagePanel(this));
	...
	*/
	...
	private void pluginListUpdated()
	{
		...
		if(selected == installer || selected == updater || selected == packages)
		{
	...
	public boolean isDownloadingPluginList() {
		return downloadingPluginList;
	}
