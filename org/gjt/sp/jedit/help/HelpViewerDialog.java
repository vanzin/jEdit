 ...
 * @version $Id$
 */
public class HelpViewerDialog extends JFrame implements HelpViewer, EBComponent, HelpHistoryModelListener
{
	 ...
	 * @param url The URL
	 */
	public HelpViewerDialog(URL url)
	{
		this(url.toString());
	} //}}}
	 ...
	 * @param url The URL
	 */
	public HelpViewerDialog(String url)
	{
