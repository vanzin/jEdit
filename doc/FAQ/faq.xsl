...
<!--
	 This customization file for the jEdit FAQ is based upon the
	 customization file used for plugin help files.

     If you want all output in a single HTML file, specify the path to
     your DocBook-XSL "html/onechunk.xsl" file in the <xsl:import>
...
<!-- NOTE: path to import file on local installation follows             -->
<!-- TODO: change location of import as necessary for your installation  -->
...
<!-- NOTE: Eliminate table borders in revhistory rendition -->
<xsl:template match="revhistory" mode="titlepage.mode">
	<xsl:apply-templates select="."/>
</xsl:template>


<!-- NOTE: The next two templates should be commented if   -->
<!-- NOTE: navigation headers are desired                  -->
<!--
...
<!-- NOTE: the remaining templates in this stylesheet deal with -->
<!-- NOTE: a table of contents and index; comment them out      -->
<!-- NOTE: if these elements are not desired                    -->
